...
configuration_options = {
    ...
    {
        name = "MOON_SHOP_CURRENCY",
        label = "商店货币类型",
        hover = "选择小月亮商店使用的货币 (原版金块无需任何依赖Mod)",
        options = {
            { description = "金块 (goldnugget)", data = "goldnugget" },
            { description = "噩梦燃料 (nightmarefuel)", data = "nightmarefuel" },
            { description = "紫宝石 (purplegem)", data = "purplegem" },
        },
        default = "goldnugget",
    },
    {
        name = "moon_shop_cost_redgem",
        label = "红宝石 兑换花费",
        hover = "兑换红宝石需要的货币数量",
        options = {
    ...
    {
        name = "moon_shop_cost_nightmarefuel",
        label = "噩梦燃料 兑换花费",
        hover = "兑换噩梦燃料需要的货币数量",
        options = {
            { description = "5", data = 5 },
    ...
    {
        name = "moon_shop_cost_opalpreciousgem",
        label = "蛋白石 兑换花费",
        hover = "兑换蛋白石需要的货币数量",
        options = {
            { description = "100", data = 100 },
